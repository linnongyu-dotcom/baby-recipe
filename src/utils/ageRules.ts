...
export const AGE_RULES: Record<AgeGroup, AgeRule> = {
  ...
  '9-11m': {
    ...
    weeklyChecks: [
      ...
      { key: 'vegetable', name: '蔬菜', icon: '🥦', category: 'darkVeg', dailyTarget: 7, suggestion: '建议每日安排蔬菜，深浅搭配更丰富' },
  ...
  '1-2y': {
    ...
    weeklyChecks: [
      ...
      { key: 'vegetable', name: '蔬菜', icon: '🥦', category: 'darkVeg', dailyTarget: 5, suggestion: '建议每日安排蔬菜，深浅搭配更均衡' },
      { key: 'fruit',     name: '水果', icon: '🍎', category: 'fruit',  dailyTarget: 7, suggestion: '建议每日安排水果' },
